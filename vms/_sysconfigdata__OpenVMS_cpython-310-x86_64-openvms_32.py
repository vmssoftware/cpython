...
build_time_vars = {'ABIFLAGS': '',
 ...
 'AR': 'LIBRARY',
 'ARFLAGS': '/CREATE',
 'BASECFLAGS': '/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/L_DOUBLE_SIZE=64',
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 ...
 'CC': 'CC',
 'CCSHARED': '',
 'CFLAGS': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/L_DOUBLE_SIZE=64',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': '',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/L_DOUBLE_SIZE=64',
 'CONFIGURE_CPPFLAGS': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/L_DOUBLE_SIZE=64',
 'CONFIGURE_LDFLAGS': '',
 ...
 'CPPFLAGS': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/L_DOUBLE_SIZE=64',
 'CXX': 'CXX',

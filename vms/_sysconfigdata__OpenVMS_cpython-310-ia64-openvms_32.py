...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CC': 'CC',
 'CCSHARED': '',
 'CFLAGS': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': '',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CONFIGURE_CPPFLAGS': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CONFIGURE_LDFLAGS': '',
 ...
 'CPPFLAGS': '/NODEBUG/NOOPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])',
 'CXX': 'CXX',

...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CC': 'CC',
 'CCSHARED': '',
 'CFLAGS': '/NODEBUG/OPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/POINTER=64/L_DOUBLE_SIZE=64',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': '',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '/NODEBUG/OPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/POINTER=64/L_DOUBLE_SIZE=64',
 'CONFIGURE_CPPFLAGS': '/NODEBUG/OPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/POINTER=64/L_DOUBLE_SIZE=64',
 'CONFIGURE_LDFLAGS': '',
 ...
 'CPPFLAGS': '/NODEBUG/OPTIMIZE/NOLIST/NAMES=(AS_IS,SHORTENED)/WARNINGS=WARNINGS=ALL/DEFINE=(_NDEBUG,_USE_STD_STAT))/INCLUDE_DIRECTORY=([],[.Include])/POINTER=64/L_DOUBLE_SIZE=64',
 'CXX': 'CXX',
